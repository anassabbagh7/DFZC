...
let FZA = new CountUp("FZA", 0, 11);
FZA.start();
let FZ = new CountUp("FZ", 0, 27);
FZ.start();
let DE = new CountUp("DE", 0, 38);
DE.start();
let DFT = new CountUp("DFT", 0, 40);
DFT.start();
let DL = new CountUp("DL", 0, 500);
DL.start();
let WF = new CountUp("WF", 0, 100);
WF.start();
...
let But = document.getElementById("TopButton");
